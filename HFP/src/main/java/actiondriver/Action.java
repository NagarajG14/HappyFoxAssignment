...
public class Action extends BaseClass implements ActionInterface {
	...
	public static Logger log = Logger.getLogger("AT");
	...
	public void click(WebDriver driver, WebElement ele) {
		...
		//test.log(Status.INFO, "Clicking on : " + ele);
		CustomListeners.testReport.get().log(Status.INFO, "Clicking on : " + ele);
	}
	...
	public boolean type(WebElement ele, String text) {
		...
		try {
			...
			if (flag) {
				...
				CustomListeners.testReport.get().log(Status.INFO, "Typing on : " + ele);
			} else {
				CustomListeners.testReport.get().log(Status.INFO, "Typing on : " + ele);
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8082/job/Xpresslane/ws/Sanitysuite/ScreenShots/" + filename
				+ "_" + dateName + ".png";
